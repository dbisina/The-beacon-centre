      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="rounded-2xl bg-slate-900 p-8 text-white">
          <div className="flex items-center gap-4">
            <Button variant="outline" size="sm" asChild className="bg-transparent border-slate-600 text-white hover:bg-slate-800 hover:text-white">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold">Add Video Sermon</h1>
          ...
          <CardContent className="pt-6">
            ...
            {!youtubeUtils.isConfigured() && (
              <div className="mt-4 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                <h4 className="font-medium text-amber-900 mb-2">Setup YouTube API (Recommended)</h4>
                <div className="text-sm text-amber-800 space-y-2">
                  <p>To enable automatic video metadata fetching:</p>
                  <ol className="list-decimal list-inside space-y-1 ml-4">
                    <li>Go to <a href="https://console.developers.google.com/" target="_blank" rel="noopener noreferrer" className="underline hover:text-amber-900">Google Cloud Console</a></li>
                    <li>Create a new project or select an existing one</li>
                    <li>Enable the "YouTube Data API v3"</li>
                    <li>Create an API key and restrict it to YouTube Data API</li>
                    <li>Add the API key to your environment variables as <code className="bg-amber-100 px-1 rounded">NEXT_PUBLIC_YOUTUBE_API_KEY</code></li>
                  </ol>
                  <p className="text-xs text-amber-700 mt-2">
                    YouTube API has a generous free tier (10,000 units per day), more than enough for most churches.
                  </p>
                </div>
              </div>
            )}
        ...
        <Card className="bg-slate-50 border-slate-200">
          <CardHeader>
            <CardTitle className="text-lg text-slate-800">Tips for Adding Video Sermons</CardTitle>
          </CardHeader>
