...
/**
 * Line icons approximating the lucide-react set the dashboard uses, drawn as
 * strokes so they stay crisp at any size. Names match the `icon` keys in NAV.
 */
